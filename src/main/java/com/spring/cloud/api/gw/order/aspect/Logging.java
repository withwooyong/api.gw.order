package com.spring.cloud.api.gw.order.aspect;
...
public class Logging {
     ...
     */
    @Pointcut("execution(* com.spring.cloud.api.gw.order.controller..*Controller*.*(..)) || execution(* com.spring.cloud.api.gw.order.service..*Service*.*(..))")
    private void cut() {
    }
